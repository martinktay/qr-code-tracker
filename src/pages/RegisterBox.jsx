...
import { Package, User, MapPin, DollarSign, Camera, Download, Search } from 'lucide-react'
...
const RegisterBox = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Create box record with enhanced fields
      const boxRecord = {
        box_id: boxId,
  ...
  const downloadLabel = () => {
    if (boxData) {
      ParcelLabelPDF.generatePDF(boxData)
    }
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-white">Register New Box</h1>
        <p className="text-gray-400">
          Register a new box for shipping and generate tracking QR code
        </p>
      </div>
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardHeader>
            ...
            <CardDescription className="text-gray-400">
              Enter box details and customer information
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {/* Box Information */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Box Information</h3>
        ...
        <div className="space-y-6">
                ...
                {boxData && (
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-300">Box ID:</span>
          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent className="space-y-2 text-sm text-gray-400">
              ...
              <p>3. Enter box contents and specifications</p>
              <p>4. Submit to generate QR code and tracking label</p>
              <p>5. Print and attach the label to the box</p>
            </CardContent>
          </Card>
        </div>
      </div>
