...
import { Package, User, MapPin, DollarSign, Camera, Download } from 'lucide-react'
...
const RegisterBox = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const createdBox = await db.createBox(boxRecord)
  ...
  const downloadLabel = () => {
    if (boxData) {
      ParcelLabelPDF.generateLabel(boxData, 'box')
    }
  }
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Register Box</h1>
        <p className="mt-1 text-sm text-gray-500">
          Register a new box with customer information and generate tracking QR code
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Registration Form */}
        <div className="card">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Box Information</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="input-field"
                placeholder="Describe the contents of the box..."
              />
              {errors.content && (
        ...
        <div className="space-y-6">
          {generatedQR && (
            <>
              <div className="card">
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="text-center">
                    <p className="text-sm text-gray-600">Box ID: {boxData?.box_id}</p>
                    <p className="text-sm text-gray-600">
                      {boxData?.customer?.first_name} {boxData?.customer?.last_name}
                    </p>
                  </div>
                  <button
              ...
              <div className="card">
                <h2 className="text-lg font-medium text-gray-900 mb-4">Box Details</h2>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Content:</span>
                    <span className="text-sm font-medium">{boxData?.content}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">{boxData?.destination}</span>
                  </div>
                  <div className="flex justify-between">
          ...
          {!generatedQR && (
            <div className="card">
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Register a box to generate a QR code and label.
                </p>
              </div>
            </div>
          )}
